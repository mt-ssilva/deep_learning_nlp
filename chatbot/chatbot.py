...
#Tradução de de todas as perguntas e respostas para inteiros
...
def decodifica_base_teste(encoder_estado, decodificador_celula,
                          decodificador_embedded_matrix, sos_id,
                          eos_id, tamanho_maximo, numero_palavras,
                          decodificador_escopo, funcao_saida,
                          keep_prob, batch_size):
...
def modelo_seq2seq(entradas, saidas, keep_prob, batch_size, tamanho_sequencia,
    ...
    decodificador_embedded_entradas = tf.nn.embedding_lookup(decodificador_embeddings_matrix, saidas_preprocessadas)
